...
_See code: [src/commands/mcp/start.ts](https://github.com/hesedcasa/mcp-server/blob/v0.1.3/src/commands/mcp/start.ts)_
...
_See code: [src/commands/mcp/token/delete.ts](https://github.com/hesedcasa/mcp-server/blob/v0.1.3/src/commands/mcp/token/delete.ts)_
...
_See code: [src/commands/mcp/token/generate.ts](https://github.com/hesedcasa/mcp-server/blob/v0.1.3/src/commands/mcp/token/generate.ts)_
...
_See code: [src/commands/mcp/token/show.ts](https://github.com/hesedcasa/mcp-server/blob/v0.1.3/src/commands/mcp/token/show.ts)_
<!-- commandsstop -->
